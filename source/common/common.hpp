...
namespace common
{
    ...
    template<typename type1, typename type2> void distribute_equally(const type1&, std::vector<type2>&, void (*)(type2&, type1*&));
    
    template<typename type1, typename type2> void distribute_by_percent(const type1&, std::vector<type2>&, 
            void (*)(type2&, type1*&),
            bool (*)(type2&, unsigned int&));
